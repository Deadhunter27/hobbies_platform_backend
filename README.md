...
> **Status:** Foundation only. This repository intentionally contains **no business logic yet**. It establishes the engineering standards, architecture, and conventions that all future implementation must follow.
...
src/              Application source (currently foundation only)
...
- [Architecture Decision Records](docs/adr/README.md) — 14 accepted decisions
